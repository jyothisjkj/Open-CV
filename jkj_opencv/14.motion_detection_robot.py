...
back_sub = cv2.createBackgroundSubtractorMOG2(history=50,
...
# Capture frames continuously from the ca
while True:
...
#      raw_capture.truncate(0)
    ...
    cv2.putText(image, text, (x2 - 10, y2 - 10),cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
    move.left(80)
    time.sleep(5)
    move.stop()
    # Display the resulting frame
